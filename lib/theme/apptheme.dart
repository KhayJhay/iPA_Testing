...
class DarkTheme extends AppTheme {
  DarkTheme({
    ...
    Color bottomIconColor = Colors.grey,
...
class LightTheme extends AppTheme {
  LightTheme({
    Color flashingCircleDarkColor = Colors.black,
    Color bottomIconColor = Colors.grey,
    TextStyle incomingChatLinkTitleStyle = const TextStyle(color: Colors.black),
    ...
    Color primaryColor = const Color(0xFF282565),
    Color secondaryColor = const Color(0xFF09AB98),
    ...
    Color verticalBarColor = Colors.black,
