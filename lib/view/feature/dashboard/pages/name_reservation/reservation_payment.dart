...
class Reservation_Payment extends StatefulWidget {
  const Reservation_Payment({super.key});

  @override
  State<Reservation_Payment> createState() => _Reservation_PaymentState();
}

class _Reservation_PaymentState extends State<Reservation_Payment> {
  int current = 0;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: PreferredSize(
          ...
          child: Custom_AppBar(
            title: 'Name Reservation - Payment',
            hasBackbtn: true,
            hasAction: true,
            backBtn: isReserved
                ? () async {
                    ...
                    await prefs.setBool('isReserved', false);
                    quitAlert(context);
                  }
                : () {
          ...
          child: ListView(
            children: [
              ...
              Align(
                alignment: Alignment.centerLeft,
                child: AppText(
                  text: "You are about to make a payment of GHS 50",
                  fontSize: 12,
                  textOverflow: TextOverflow.visible,
                  textAlign: TextAlign.left,
                    ...
                    if (contactController.text.isNotEmpty) {
                      ...
                      Timer(Duration(seconds: 3), () {
                        ...
                        Get.snackbar('Payment Success',
                            "Payment made successfully, Name reserved",
                            backgroundColor: Colors.green,
                            colorText: Colors.white,
                            icon: Icon(IconlyBold.shield_done));
                        Get.off(
                            () => ReservedNames(
                                  isFromLogin: isReserved,
                                ),
                            ...
                            SizedBox(
                              ...
                              child: ListView(
                                children: [
                                  AppText(
                                    text:
                                        'Do you want to quit name reservation payment?',
                                    fontSize: 12,
